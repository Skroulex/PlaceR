...
import {schema} from "../../../../utils/validations/adminAboutForm";
                ...
                <div className={classes.right_content}>
                    <div className={classes.right_bottom}>
                        ...
                        <form onSubmit={handleSubmit(onSubmit)} className={classes.right_info}>
                            ...
                            <div>
                                <h3>Описание</h3>
                                <textarea maxLength={45} className={classes.input_area} {...register("subtitle")}> </textarea>
                                <p>{errors?.subtitle?.message}</p>
                            </div>
                            <div>
                                <h3>Краткое описание</h3>
                                <textarea maxLength={35} className={classes.input_area} {...register("short")}> </textarea>
                                <p>{errors?.short?.message}</p>
                            </div>
